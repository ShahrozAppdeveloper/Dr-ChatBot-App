...
//                String password = binding.teacherPassED.getText().toString().trim();
    ...
    private void getUserData() {
        if (uid != null) {
            DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("ProfileUser").child("User").child(uid);
    ...
    private void updateProfile(String name, String imageUri) {
        ...
        DatabaseReference usersRef = database.getReference("ProfileUser").child("User").child(uid);
