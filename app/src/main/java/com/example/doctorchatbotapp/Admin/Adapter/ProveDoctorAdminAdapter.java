...
public class ProveDoctorAdminAdapter extends RecyclerView.Adapter<ProveDoctorAdminAdapter.TeacherStudentListViewHolder> {
    private ArrayList<AddPatientDetailToRealtym> mList;
    private Context context;



    public ProveDoctorAdminAdapter(ArrayList<AddPatientDetailToRealtym> mList, Context context) {
        this.mList = mList;
    ...
    public TeacherStudentListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_doctor_prove_layout, parent, false);
